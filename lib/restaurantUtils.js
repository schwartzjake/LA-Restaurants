...
const POTENTIAL_NAME_KEYS = ['Name', 'name'];
...
const POTENTIAL_LAT_KEYS = ['Latitude', 'latitude', 'lat'];
const POTENTIAL_LNG_KEYS = ['Longitude', 'longitude', 'lng'];
const POTENTIAL_GOOGLE_MAP_KEYS = ['Google Maps URL', 'googleMapsUrl', 'google_maps_url'];
...
export const sanitizeRestaurantRecord = (record) => {
  ...
  const name = guessValue(fields, POTENTIAL_NAME_KEYS);
